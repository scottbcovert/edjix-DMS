...
function insertActionLine(){
    ...
    a1.scope="row";
    a1.innerHTML= SUGAR.language.get(module_sugar_grp1, 'LBL_SELECT_ACTION')+"&nbsp;:&nbsp;<select name='aow_actions_action[" + actln + "]' id='aow_actions_action" + actln + "' onchange='getView(" + actln + ");'>"+ app_list_actions +"</select>";

    var b1 = x.insertCell(1);
    b1.scope="row";
    b1.innerHTML= SUGAR.language.get(module_sugar_grp1, 'LBL_NAME')+"&nbsp;:&nbsp;<input name='aow_actions_name[" + actln + "]' id='aow_actions_name" + actln + "' type='text'>";
