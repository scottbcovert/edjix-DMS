...
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.flow_module.name}-input', '{$fields.flow_module.name}');sync_{$fields.flow_module.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
...
{sugar_translate label='CONDITIONS' module='AOW_WorkFlow'}
<script>
...
{sugar_translate label='ACTIONS' module='AOW_WorkFlow'}
<script>
