<?php /* Smarty version 2.6.11, created on 2013-07-09 06:10:10
         compiled from cache/modules/marin_Boats/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/marin_Boats/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/marin_Boats/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/marin_Boats/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/marin_Boats/SearchForm_advanced.tpl', 44, false),array('function', 'html_options', 'cache/modules/marin_Boats/SearchForm_advanced.tpl', 84, false),array('function', 'sugar_getimage', 'cache/modules/marin_Boats/SearchForm_advanced.tpl', 233, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
			<label for='name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'marin_Boats'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='year_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_YEAR','module' => 'marin_Boats'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php echo smarty_function_html_options(array('name' => 'year_advanced[]','options' => $this->_tpl_vars['fields']['year_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => 1,'selected' => $this->_tpl_vars['fields']['year_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='make_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MAKE','module' => 'marin_Boats'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['make_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['make_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['make_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['make_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['make_advanced']['name']; ?>
' size='30' 
    maxlength='30' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='model_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MODEL','module' => 'marin_Boats'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['model_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['model_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['model_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['model_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['model_advanced']['name']; ?>
' size='30' 
    maxlength='30' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='hin_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_HIN','module' => 'marin_Boats'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			
<?php if (strlen ( $this->_tpl_vars['fields']['hin_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['hin_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['hin_advanced']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['hin_advanced']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['hin_advanced']['name']; ?>
' size='30' 
    maxlength='20' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='assigned_user_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'marin_Boats'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
