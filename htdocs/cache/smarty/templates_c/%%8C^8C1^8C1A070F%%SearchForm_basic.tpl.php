<?php /* Smarty version 2.6.11, created on 2013-07-09 06:09:00
         compiled from cache/modules/marin_Boats/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/marin_Boats/SearchForm_basic.tpl', 31, false),array('function', 'math', 'cache/modules/marin_Boats/SearchForm_basic.tpl', 32, false),array('function', 'sugar_translate', 'cache/modules/marin_Boats/SearchForm_basic.tpl', 41, false),array('function', 'sugar_getimagepath', 'cache/modules/marin_Boats/SearchForm_basic.tpl', 157, false),array('modifier', 'count', 'cache/modules/marin_Boats/SearchForm_basic.tpl', 144, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'marin_Boats'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='make_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_MAKE','module' => 'marin_Boats'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['make_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['make_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['make_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['make_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['make_basic']['name']; ?>
' size='30' 
    maxlength='30' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='hin_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_HIN','module' => 'marin_Boats'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['hin_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['hin_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['hin_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['hin_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['hin_basic']['name']; ?>
' size='30' 
    maxlength='20' 
    value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'marin_Boats'), $this);?>
</label>
    	</td>
