<?php /* Smarty version 2.6.11, created on 2013-07-09 22:53:53
         compiled from modules/Home/UnifiedSearchAdvancedForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_getjspath', 'modules/Home/UnifiedSearchAdvancedForm.tpl', 44, false),array('function', 'sugar_translate', 'modules/Home/UnifiedSearchAdvancedForm.tpl', 62, false),array('function', 'sugar_getimage', 'modules/Home/UnifiedSearchAdvancedForm.tpl', 63, false),array('function', 'sugar_getimagepath', 'modules/Home/UnifiedSearchAdvancedForm.tpl', 107, false),)), $this); ?>
...
&nbsp;
            ...
            <?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_HIDE_OPTIONS'), $this); $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('alt_hide_show', ob_get_contents());ob_end_clean(); ?>
			...
			<?php else: ?>
            <?php ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_ALT_SHOW_OPTIONS'), $this); $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('alt_hide_show', ob_get_contents());ob_end_clean(); ?>
