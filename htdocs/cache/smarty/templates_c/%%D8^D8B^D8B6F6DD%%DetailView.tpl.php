<?php /* Smarty version 2.6.11, created on 2013-07-09 05:48:26
         compiled from cache/modules/Accounts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Accounts/DetailView.tpl', 33, false),array('function', 'counter', 'cache/modules/Accounts/DetailView.tpl', 38, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/DetailView.tpl', 41, false),array('function', 'sugar_translate', 'cache/modules/Accounts/DetailView.tpl', 44, false),array('function', 'sugar_getjspath', 'cache/modules/Accounts/DetailView.tpl', 72, false),array('function', 'sugar_phone', 'cache/modules/Accounts/DetailView.tpl', 131, false),array('function', 'sugar_ajax_url', 'cache/modules/Accounts/DetailView.tpl', 310, false),array('modifier', 'strip_semicolon', 'cache/modules/Accounts/DetailView.tpl', 58, false),array('modifier', 'substr', 'cache/modules/Accounts/DetailView.tpl', 157, false),array('modifier', 'to_url', 'cache/modules/Accounts/DetailView.tpl', 159, false),array('modifier', 'escape', 'cache/modules/Accounts/DetailView.tpl', 204, false),array('modifier', 'url2html', 'cache/modules/Accounts/DetailView.tpl', 204, false),array('modifier', 'nl2br', 'cache/modules/Accounts/DetailView.tpl', 204, false),array('modifier', 'strip_tags', 'cache/modules/Accounts/DetailView.tpl', 210, false),)), $this); ?>
...
<!--not_in_theme!--><img id="dswidget_img" border="0" src="modules/Connectors/connectors/formatters/ext/rest/linkedin/tpls/linkedin.gif" alt="ext_rest_linkedin" onclick="show_ext_rest_linkedin(event);"><script type='text/javascript' src='<?php echo smarty_function_sugar_getjspath(array('file' => 'include/connectors/formatters/default/company_detail.js'), $this);?>
'></script>
<script src="<?php if ($_SERVER['HTTPS'] === 'on'): ?>index.php?entryPoint=get_url&type=linkedin<?php else: ?>http://www.linkedin.com/companyInsider?script&useBorder=no<?php endif; ?>" type="text/javascript"></script>
...
<td width='12.5%' scope="col">
<?php if (! $this->_tpl_vars['fields']['marin_boats_accounts_name']['hidden']):  ob_start();  echo smarty_function_sugar_translate(array('label' => 'LBL_MARIN_BOATS_ACCOUNTS_FROM_MARIN_BOATS_TITLE','module' => 'Accounts'), $this); $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean();  echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
<?php endif; ?>
</td>
<td width='37.5%'  >
<?php if (! $this->_tpl_vars['fields']['marin_boats_accounts_name']['hidden']):  echo smarty_function_counter(array('name' => 'panelFieldCount'), $this);?>


<?php if (! empty ( $this->_tpl_vars['fields']['marin_boats_accountsmarin_boats_ida']['value'] )):  ob_start(); ?>index.php?module=marin_Boats&action=DetailView&record=<?php echo $this->_tpl_vars['fields']['marin_boats_accountsmarin_boats_ida']['value'];  $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('detail_url', ob_get_contents());ob_end_clean(); ?>
<a href="<?php echo smarty_function_sugar_ajax_url(array('url' => $this->_tpl_vars['detail_url']), $this);?>
"><?php endif; ?>
<span id="marin_boats_accountsmarin_boats_ida" class="sugar_field" data-id-value="<?php echo $this->_tpl_vars['fields']['marin_boats_accountsmarin_boats_ida']['value']; ?>
"><?php echo $this->_tpl_vars['fields']['marin_boats_accounts_name']['value']; ?>
</span>
<?php if (! empty ( $this->_tpl_vars['fields']['marin_boats_accountsmarin_boats_ida']['value'] )): ?></a><?php endif;  endif; ?>
</td>
</tr>
<?php $this->_smarty_vars['capture']['tr'] = ob_get_contents();  $this->assign('tableRow', ob_get_contents());ob_end_clean();  if ($this->_tpl_vars['fieldsUsed'] > 0 && $this->_tpl_vars['fieldsUsed'] != $this->_tpl_vars['fieldsHidden']):  echo $this->_tpl_vars['tableRow']; ?>
