...
*}
<script src="{if $smarty.server.HTTPS === 'on'}index.php?entryPoint=get_url&type=linkedin{else}<?php echo $this->_tpl_vars['config']['properties']['company_url']; ?>
{/if}" type="text/javascript"></script>
...
.value}");
cd.display();
linked_in_popup = new LinkedIn.CompanyInsiderBox("linkedin_div", "{$fields.<?php echo $this->_tpl_vars['mapping_name']; ?>
.value}");
{literal}
} 
{/literal}
