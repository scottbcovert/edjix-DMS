<?php /* Smarty version 2.6.11, created on 2013-07-11 21:21:33
         compiled from themes/ModernAqua/tpls/_headerModuleList.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_link', 'themes/ModernAqua/tpls/_headerModuleList.tpl', 70, false),array('function', 'sugar_getimagepath', 'themes/ModernAqua/tpls/_headerModuleList.tpl', 99, false),)), $this); ?>
...
if ($this->_foreach['moduleList']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['name'] => $this->_tpl_vars['module']):
        $this->_foreach['moduleList']['iteration']++;
?>
    <li class="<?php if ($this->_tpl_vars['name'] == $this->_tpl_vars['MODULE_TAB']): ?>currentTab<?php else: ?>notCurrentTab<?php endif; ?>"><?php ob_start();  $this->assign('file', ($this->_tpl_vars['name']).".png"); ?>background-image:url(<?php echo smarty_function_sugar_getimagepath(array('file' => $this->_tpl_vars['file']), $this);?>
)<?php $this->_smarty_vars['capture']['icon_style'] = ob_get_contents();  $this->assign('icon_style', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_link(array('id' => "moduleTab_".($this->_tpl_vars['name']),'module' => $this->_tpl_vars['name'],'style' => $this->_tpl_vars['icon_style']), $this);?>
</li>
    <?php endforeach; endif; unset($_from); ?>
...
if ($this->_foreach['moduleList']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['name'] => $this->_tpl_vars['module']):
        $this->_foreach['moduleList']['iteration']++;
?>
    <li class="notCurrentTab"><?php ob_start();  $this->assign('file', ($this->_tpl_vars['name']).".png"); ?>background-image:url(<?php echo smarty_function_sugar_getimagepath(array('file' => $this->_tpl_vars['file']), $this);?>
)<?php $this->_smarty_vars['capture']['icon_style'] = ob_get_contents();  $this->assign('icon_style', ob_get_contents());ob_end_clean();  echo smarty_function_sugar_link(array('id' => "moduleTab_".($this->_tpl_vars['name']),'module' => $this->_tpl_vars['name'],'data' => $this->_tpl_vars['module'],'style' => $this->_tpl_vars['icon_style']), $this);?>
</li>
    <?php endforeach; endif; unset($_from); ?>
</ul>
</div>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "themes/ModernAqua/tpls/_headerShortcuts.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "themes/ModernAqua/tpls/_headerLastViewed.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
<?php endif; ?>