...
<input class="checkbox" type="checkbox" name="newTasks" id="newTasks" onclick="toggleDisplay('createTasks');if (typeof(addRemoveDropdownElement) == 'function') addRemoveDropdownElement('Tasks');<?php if (! empty ( $this->_tpl_vars['def']['select'] )): ?>toggleTasksSelect();<?php endif; ?>">
<script type="text/javascript">
