...
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['flow_module']['value'] ) && $this->_tpl_vars['fields']['flow_module']['value'] != ''):  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['flow_module']['options'],'selected' => $this->_tpl_vars['fields']['flow_module']['value']), $this);?>

<?php else:  echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['flow_module']['options'],'selected' => $this->_tpl_vars['fields']['flow_module']['default']), $this);?>

<?php endif; ?>
</select>
<?php else:  $this->assign('field_options', $this->_tpl_vars['fields']['flow_module']['options']);  ob_start();  echo $this->_tpl_vars['fields']['flow_module']['value'];  $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean();  $this->assign('field_val', $this->_smarty_vars['capture']['field_val']);  ob_start();  echo $this->_tpl_vars['fields']['flow_module']['name'];  $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean();  $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
...
<?php echo '
(function (){
var selectElem = document.getElementById("';  echo $this->_tpl_vars['fields']['flow_module']['name'];  echo '");
...
//global variable 
sync_';  echo $this->_tpl_vars['fields']['flow_module']['name'];  echo ' = function(){
SyncToHidden();
}
...
for (i=0;i<selectElem.options.length;i++){
if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById(\'';  echo $this->_tpl_vars['fields']['flow_module']['name']; ?>
-input<?php echo '\'))
SUGAR.AutoComplete.';  echo $this->_tpl_vars['ac_key'];  echo '.inputNode.set(\'value\',selectElem.options[i].innerHTML);
}
}
YAHOO.util.Event.onAvailable("';  echo $this->_tpl_vars['fields']['flow_module']['name'];  echo '", syncFromHiddenToWidget);
'; ?>
...
<script type="text/javascript">
addForm(\'EditView\');addToValidate(\'EditView\', \'name\', \'name\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'date_entered_date\', \'date\', false,\'Date Created\' );
addToValidate(\'EditView\', \'date_modified_date\', \'date\', false,\'Date Modified\' );
addToValidate(\'EditView\', \'modified_user_id\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'modified_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MODIFIED_NAME','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by\', \'assigned_user_name\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'created_by_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'description\', \'text\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'deleted\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_DELETED','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_id\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_ID','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'assigned_user_name\', \'relate\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO_NAME','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'flow_module\', \'enum\', true,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_FLOW_MODULE','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'status\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_STATUS','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'run_when\', \'enum\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_RUN_WHEN','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'multiple_runs\', \'bool\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_MULTIPLE_RUNS','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'condition_lines\', \'function\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_CONDITION_LINES','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidate(\'EditView\', \'action_lines\', \'function\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_ACTION_LINES','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\' );
addToValidateBinaryDependency(\'EditView\', \'assigned_user_name\', \'alpha\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'AOW_WorkFlow','for_js' => true), $this); echo ': ';  echo smarty_function_sugar_translate(array('label' => 'LBL_ASSIGNED_TO','module' => 'AOW_WorkFlow','for_js' => true), $this); echo '\', \'assigned_user_id\' );
